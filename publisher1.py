...
srv_addr = sys.argv[1] if len(sys.argv) > 1 else "10.0.0.2"
...
while True:
    ...
    socket.send_string("%i %i %i %i %i" % (zipcode, temperature, relhumidity, ownership_strength, history))
